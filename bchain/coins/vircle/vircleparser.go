...
// VircleParser handle
type VircleParser struct {
	*btc.BitcoinLikeParser
	BaseParser *bchain.BaseParser
}

// NewVircleParser returns new VircleParser instance
func NewVircleParser(params *chaincfg.Params, c *btc.Configuration) *VircleParser {
	parser := &VircleParser{
...
func (p *VircleParser) GetMaxAddrLength() int {
...
func (p *VircleParser) UnpackTx(buf []byte) (*bchain.Tx, uint32, error) {
...
func (p *VircleParser) TxFromMsgTx(t *wire.MsgTx, parseAddresses bool) bchain.Tx {
	tx := p.BitcoinLikeParser.TxFromMsgTx(t, parseAddresses)
	p.LoadAssets(&tx)
	return tx
}
// ParseTxFromJson parses JSON message containing transaction and returns Tx struct
func (p *VircleParser) ParseTxFromJson(msg json.RawMessage) (*bchain.Tx, error) {
...
func (p *VircleParser) ParseBlock(b []byte) (*bchain.Block, error) {
	r := bytes.NewReader(b)
	w := wire.MsgBlock{}
	h := wire.BlockHeader{}
	err := h.Deserialize(r)
...
func (p *VircleParser) GetAssetTypeFromVersion(nVersion int32) *bchain.TokenType {
...
func (p *VircleParser) GetAssetsMaskFromVersion(nVersion int32) bchain.AssetsMask {
	switch nVersion {
	case SYSCOIN_TX_VERSION_ASSET_ACTIVATE:
...
func (p *VircleParser) IsSyscoinMintTx(nVersion int32) bool {
    return nVersion == SYSCOIN_TX_VERSION_ALLOCATION_MINT
}

func (p *VircleParser) IsAssetTx(nVersion int32) bool {
...
func (p *VircleParser) IsAssetAllocationTx(nVersion int32) bool {
...
func (p *VircleParser) IsAssetSendTx(nVersion int32) bool {
    return nVersion == SYSCOIN_TX_VERSION_ASSET_SEND
}

func (p *VircleParser) IsAssetActivateTx(nVersion int32) bool {
    return nVersion == SYSCOIN_TX_VERSION_ASSET_ACTIVATE
}

func (p *VircleParser) IsSyscoinTx(nVersion int32) bool {
...
func (p *VircleParser) TryGetOPReturn(script []byte) []byte {
...
func (p *VircleParser) GetAllocationFromTx(tx *bchain.Tx) (*bchain.AssetAllocation, []byte, error) {
...
func (p *VircleParser) GetSPTDataFromDesc(addrDesc *bchain.AddressDescriptor) ([]byte, error) {
...
func (p *VircleParser) GetAssetFromVout(vout []bchain.Vout) (*bchain.Asset, error) {
	var addrDesc bchain.AddressDescriptor
	var err error
...
func (p *VircleParser) GetAssetFromDesc(addrDesc *bchain.AddressDescriptor) (*bchain.Asset, error) {
...
func (p *VircleParser) GetAssetAllocationFromDesc(addrDesc *bchain.AddressDescriptor, txVersion int32) (*bchain.AssetAllocation, []byte, error) {
	sptData, err := p.GetSPTDataFromDesc(addrDesc)
	if err != nil {
		return nil, nil, err
	}
...
func (p *VircleParser) GetAssetFromData(sptData []byte) (*bchain.Asset, error) {
...
func (p *VircleParser) GetAssetAllocationFromData(sptData []byte, txVersion int32) (*bchain.AssetAllocation, []byte, error) {
...
func (p *VircleParser) LoadAssets(tx *bchain.Tx) error {
...
func (p *VircleParser) WitnessPubKeyHashFromKeyID(keyId []byte) (string, error) {
...
func (p *VircleParser) PackAssetKey(assetGuid uint64, height uint32) []byte {
	var buf []byte
...
func (p *VircleParser) UnpackAssetKey(buf []byte) (uint64, uint32) {
...
func (p *VircleParser) PackAssetTxIndex(txAsset *bchain.TxAsset) []byte {
	var buf []byte
	varBuf := make([]byte, vlq.MaxLen64)
...
func (p *VircleParser) UnpackAssetTxIndex(buf []byte) []*bchain.TxAssetIndex {
...
func (p *VircleParser) AppendAssetInfo(assetInfo *bchain.AssetInfo, buf []byte, varBuf []byte) []byte {
...
func (p *VircleParser) UnpackAssetInfo(assetInfo *bchain.AssetInfo, buf []byte) int {
	var l int
...
func (p *VircleParser) PackTxAddresses(ta *bchain.TxAddresses, buf []byte, varBuf []byte) []byte {
	buf = buf[:0]
...
func (p *VircleParser) UnpackTxAddresses(buf []byte) (*bchain.TxAddresses, error) {
...
func (p *VircleParser) UnpackAddrBalance(buf []byte, txidUnpackedLen int, detail bchain.AddressBalanceDetail) (*bchain.AddrBalance, error) {
...
func (p *VircleParser) PackAddrBalance(ab *bchain.AddrBalance, buf, varBuf []byte) []byte {
	buf = buf[:0]
...
func (p *VircleParser) PackedTxIndexLen() int {
	return p.BaseParser.PackedTxidLen() + 1
}

func (p *VircleParser) UnpackTxIndexType(buf []byte) (bchain.AssetsMask, int) {
	maskUint, l := p.BaseParser.UnpackVaruint(buf)
	return bchain.AssetsMask(maskUint), l
}

func (p *VircleParser) UnpackTxIndexAssets(assetGuids *[]uint64, buf *[]byte) uint {
...
func (p *VircleParser) PackTxIndexes(txi []bchain.TxIndexes) []byte {
	buf := make([]byte, 0, 34)
...
func (p *VircleParser) PackAsset(asset *bchain.Asset) ([]byte, error) {
	buf := make([]byte, 0, 315)
	varBuf := make([]byte, 4)
...
func (p *VircleParser) UnpackAsset(buf []byte) (*bchain.Asset, error) {
	var asset bchain.Asset
	var ll = 0
